...
#pragma warning restore RS0016 // Add public types and members to the declared API
        ...
        string? bindPath = null)
    {
        ...
        var workingDirectory = Path.Combine(builder.AppHostDirectory, bindPath ?? Directory.GetCurrentDirectory())
        ...
        return builder.AddResource(resource)
                ...
                .WithBindMount(workingDirectory, StructurizrContainerDataDirectory)
            ;
    }
}